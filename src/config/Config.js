...
// const SERVER_PATH = process.env.NODE_ENV === 'production' ? 'http://1.234.36.147:8000/bdanbonga/' : 'http://localhost:8000/bdanbonga/'
const SERVER_PATH = 'http://1.234.36.147:8000/bdanbonga/'
/**
 * gallery path
*/
